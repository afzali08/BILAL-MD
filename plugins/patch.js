  ...
  async (message, args) => {
    try {
      ...
      if (url.toLowerCase().includes("https")) {
        ...
        return await message.send("`BILAL-MD UPDATE WAS SUCCESSFULL ✅`");
      } else {
...
${menuThemeCommandPrefix} *developer:* KING-BILAL
${menuThemeCommandPrefix} *ᴅᴀᴛᴀʙᴀsᴇ:* ${database_info}
${menuThemeFooter}  
▱▰▱▰▱▰▱▰▱▰▱▱▰▱▱▰
${Config.ownername} HEY 👋
ITX KING BILAL MD WHTSAPPP BOT \n CREATED BY KING BILAL CONTACT ME FOR ANY KIND OF HELP
▱▰▱▰▱▰▱▰▱▰▱▱▰▱▱▰
...
smd(
  ...
  async (m) => {
    try {
      ...
      const message = `*KING-BILAL-𝗜𝗡-𝗥𝗨𝗡𝗡𝗜𝗡𝗚-𝗙𝗥𝗢𝗠:* ${uptimeHours}h ${uptimeMinutes}ᴍ ${uptimeSeconds}s\n \t_ʜᴇʀᴇ's ᴍᴏʀᴇ ɪɴғᴏ_\n*ʀᴀᴍ ᴜsᴀɢᴇ:* ${ramUsage.toFixed(2)} MB\n*ᴄᴘᴜ ɴᴀᴍᴇ:* ${cpuModel}`;
      const contextInfo = {
        isForwarded: true,
        forwardingScore: 999,
        title: "BILAL MD Running Since",
        body: message,
        footerText: "BILAL MD 2024",
    ...
    try {
      ...
      if (!isNaN(_0x56b5d3)) {
        if (
          ...
          _0x1eb88a[1][_0x210c92(362)]("BILAL-MD_FANCY_TEXT")
        ) {
