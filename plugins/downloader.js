...
`;
     ...
     try {
       ...
       for (let i = startIndex - 1; i < endIndex; i++) {
         ...
         if (isSticker) {
           ...
           await message.reply(
             sticker,
             { packname: Config.packname, author: "BILAL-Md" },
             "sticker"
           );
         } else {
     ...
     try {
       ...
       if (!_0x1c586e) {
         return await _0x1ae8f8.reply(
           "*Provide Repo Url, _.gitclone https://github.com/ItxxBILAL/BILAL-Md_*"
         );
       }
       const _0x5906ab =
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am BILAL-Md whatsapp bot._*");
     }
     try {
 ...
 smd({
   pattern: "sound",
    alias: ["BILALi", "aine","mentalism","alive","waso"],
   ...
   try {
     ...
     let _0xf0331a = "https://github.com/ItxxBILAL/Tiktokmusic-API/raw/master/tiktokmusic/sound" + _0x19c223.toString() + ".mp3";
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *BILAL MD V2 -ᴍᴅ Mᴇᴅɪᴀғɪʀᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
...
smd({
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("BILAL MD V2 -ᴍᴅ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x452f00 = _0x5c3baf.title || _0x57ada1 || _0x13f167[0x1] || "BILAL MD -- YT Video";
      if (_0x57ada1) {
